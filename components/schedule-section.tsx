...
export function ScheduleSection() {
  ...
  const schedule = [
    {
      day: "Day 1 - September 5, 2026",
      events: [
        { time: "9:00 AM - 10:00 AM", title: "Registration & Check-in", description: "Get your badge and swag" },
        { time: "10:00 AM - 10:15 AM", title: "Opening Ceremony", description: "Welcome address and kickoff" },
        { time: "10:30 AM", title: "Coding Begins", description: "Start building your projects" },
        {
          time: "11:00 AM - 12:00 PM",
          title: "App Development Workshop",
          description: "Learn essential app development skills",
        },
        { time: "1:00 PM - 2:00 PM", title: "Lunch", description: "Refuel and network" },
        { time: "2:15 PM - 3:45 PM", title: "Dhuhr Prayer", description: "Prayer break" },
        {
          time: "3:45 PM - 4:30 PM",
          title: "API Integration & LLMs Workshop",
          description: "Learn to work with APIs and large language models",
        },
        { time: "5:30 PM - 6:15 PM", title: "Resume Workshop", description: "Optimize your resume for tech careers" },
        { time: "7:30 PM", title: "Asr Prayer", description: "Prayer break" },
        { time: "8:00 PM", title: "Dinner", description: "Evening meal" },
        { time: "9:40 PM", title: "Maghrib Prayer", description: "Prayer break" },
        { time: "11:30 PM", title: "Isha Prayer & Khatirah", description: "Prayer and short talk" },
        { time: "1:00 AM", title: "Midnight Games", description: "Fun activities to keep the energy going" },
      ],
    },
    {
      day: "Day 2 - September 6, 2026",
      events: [
        { time: "5:30 AM", title: "Fajr Prayer", description: "Morning prayer" },
        { time: "8:00 AM", title: "Breakfast", description: "Start your day right" },
        { time: "10:00 AM", title: "Project Submission Deadline", description: "Hacking ends, submit your projects" },
        {
          time: "10:00 AM - 1:00 PM",
          title: "Presentations & Judging",
          description: "Present your projects to the judges",
        },
        { time: "1:00 PM", title: "Awards & Closing Ceremony", description: "Winners announced and final remarks" },
      ],
    },
  ]
